...
namespace ERClubs.Controllers
{
    ...
    public class ERCountryController : Controller
    {
        private readonly ERClubsContext _context;

        public ERCountryController(ERClubsContext context)
        {
            _context = context;
        }
