...
{
    public class ERInstrumentController : Controller
    {
        private readonly ERClubsContext _context;

        public ERInstrumentController(ERClubsContext context)
        {
            _context = context;
        }
        ...
        // GET: ERInstrument/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: ERInstrument/Create
